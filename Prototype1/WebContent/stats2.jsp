...
System.out.println("Connecting to database...");
  ...
  try(
    CallableStatement statement = conn.prepareCall("{call journalsummary()}");
    )
 {
    boolean hadResults = statement.execute();
 %>

 <h1 style="font-size:4vw" align="center">Summary of Journal</h1>
...
<% 
    while (hadResults) {
        ...
        while (resultSet.next()) {
            ...
            String id = resultSet.getString("jid");
